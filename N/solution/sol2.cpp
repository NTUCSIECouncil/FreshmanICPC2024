...
int compare_straight(vector<card> yours, vector<card> opponents)
{
    if (yours[0].number == 1 && yours[0].number == 10)
        return 1;
    if (opponents[0].number == 1 && opponents[0].number == 10)
        return 0;
    if (yours[4].number >= opponents[4].number)
        return 1;
    return 0;
}

int general_compare(vector<card> yours, vector<card> opponents)
{
    if (yours[0].number == 1)
        return 1;
    if (opponents[0].number == 1)
        return 0;
    if (yours[4].number >= opponents[4].number)
        return 1;
    return 0;
...
int compare_hand_rankings(vector<card> yours, vector<card> opponents)
{
    int your_rank = which_hand_rankings(yours);
    int opponents_rank = which_hand_rankings(opponents);
    if (your_rank < opponents_rank)
        return 1;
    else if (your_rank > opponents_rank)
        return 0;
    int rank = your_rank;
    if (rank == 1)
        return 1;
    else if (rank == 2)
        return compare_straight(yours, opponents);
    else if (rank == 3)
        return (yours[1].number >= opponents[1].number);
    else if (rank == 4)
        return (yours[2].number >= opponents[2].number);
    else if (rank == 5)
        return general_compare(yours, opponents);
    else if (rank == 6)
        return compare_straight(yours, opponents);
    else if (rank == 7)
        return (yours[2].number >= opponents[2].number);
    else if (rank == 8)
        return (yours[2].number);
    else
        return general_compare(yours, opponents);
}
...
int game()
{
    ...
    return compare_hand_rankings(yours, opponents);
}
